...
class MCQGenerator:
    ...
    def extract_key_phrases(self, doc) -> List[str]:
        ...
        for chunk in doc.noun_chunks:
            ...
            if 2 <= len(chunk_text.split()) <= 4 and len(chunk_text) > 3:
        ...
        return [phrase for phrase, count in phrase_counts.most_common(50)]
    
    def generate_distractors(self, correct_answer: str, answer_type: str, all_entities: Dict, key_phrases: List[str]) -> List[str]:
        ...
        # Generic distractors as fallback
        generic_distractors = {
            'PERSON': ['John Smith', 'Mary Johnson', 'Robert Brown', 'Sarah Davis'],
            'ORG': ['Microsoft', 'Google', 'Apple', 'Amazon'],
            'GPE': ['United States', 'United Kingdom', 'Germany', 'France'],
            'DATE': ['2020', '2019', '2021', '2018'],
            'MONEY': ['$100', '$500', '$1,000', '$50'],
            'PERCENT': ['25%', '50%', '75%', '10%'],
            'CARDINAL': ['100', '500', '1000', '50'],
        }
    ...
    def create_fill_in_blank_question(self, sentence: str, answer: str, answer_type: str, all_entities: Dict, key_phrases: List[str]) -> Dict[str, Any]:
    ...
    def generate_mcqs_from_text(self, text: str, num_questions: int = 5) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.info(f"Extracted entities: {sum(len(v) for v in entities.values())}")
            ...
            for sent in doc.sents:
                ...
                for ent in sent_doc.ents:
                    if (ent.label_ in entities and 
                        ent.text.strip() in entities[ent.label_] and
            ...
            for item in potential_questions:
...
class MCQGenerator:
    ...
    def create_direct_question(self, sentence: str, answer: str, answer_type: str, all_entities: Dict, key_phrases: List[str]) -> Dict[str, Any]:
